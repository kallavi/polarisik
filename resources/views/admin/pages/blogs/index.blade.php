...
@section('rightContent')
    <x-admin.tags-wrapper :class="'d-flex align-items-center'">
        <x-slot:tagsWrapper>
            ...
            <x-admin.button :link="route('blogs.create')" :title="'Blog Ekle'" :class="'d-flex flex-center h-48px h-lg-48px'" :color="'primary'" :iconTag="'i'"
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <x-admin.button :link="'/blog/'.$blog->categoryR->slug.'/'  . $blog->slug" :target="'_blank'" :class="'btn-icon'"
                                    ...
                                    <x-admin.button :link="route('blogs.edit', $blog->id)" :class="'btn-icon '" :small="''"
                                ...
                                <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline'" :action="route('blogs.destroy', $blog->id)" :method="'POST'">
                                    <x-slot:form>
                                        @method('DELETE')
