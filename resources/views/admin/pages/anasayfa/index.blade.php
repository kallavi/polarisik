...
@section('app')
    ...
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form id="'kt_ecommerce_add_product_form'" :action="route('anasayfaicerik.update')" :method="'POST'" :class="'create_form'">
                <x-slot:form>
                    @method('PUT')
                                ...
                                <x-slot:tabContent>
                                    <div class="d-flex flex-column flex-xl-row">
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 ">
                                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                <x-admin.card :class="'d-none card-flush border-0 bg-gray-300 bg-opacity-20 mb-6 pt-12'" :cardHeaderClass="'min-h-25px'">
                                                    <x-slot:cardHeader>
                                                    ...
                                                    <x-slot:cardBody>
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :type="'hidden'" :inputParentClass="'input-group-lg mb-6 fv-row col-12'" :labelTag="'label'"
                                                                    :labelText="'Başlık'" :labelClass="'form-label required'" :placeholder="'Sayfa Başlık'"
                                                                    :class="'form-control name-tr'" :name="'name:tr'"
                                                                    :value="$page->{'name:tr'}"/>
                                                                    <x-admin.form-input :type="'hidden'" :inputParentClass="'input-group-lg mb-6 fv-row col-12'" :labelTag="'label'"
                                                                        :labelText="'Başlık'" :labelClass="'form-label required'" :placeholder="'Sayfa Başlık'"
                                                                        :class="'form-control name-tr'" :name="'id'"
                                                                        :value="$page->id"/>
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
