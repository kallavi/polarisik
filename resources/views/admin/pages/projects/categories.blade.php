...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Proje Kategorileri'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline ms-3'" :action="route('projectcategories.destroy', $category->id)"
                                            :method="'POST'">
                                            <x-slot:form>
                                                @method('DELETE')
                                ...
                                <!---Project Kategori Güncelle Modal--->
                                <x-admin.modal :id="'category' . $category->id" :modalTitle="'Kategori Güncelle'" :headerNotBorder="''" :titleCenter="''"
                                    ...
                                    <x-slot:modalBody>
                                        <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('projectcategories.update', $category->id)" :method="'POST'"
                                            :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework project_create_form'" :dataKt="[
                                                'redirect' =>
                                                ...
                                                <x-admin.custom-grid>
                                                    <x-slot:gridRow>
                                                        <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row'" :type="'hidden'"
                                                            :name="'id'" :labelTag="'label'" :labelText="'Türkçe Kategori Adı'"
                                                        ...
                                                        <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row'" :name="'name:ar'"
                                                            ...
                                                            :placeholder="'Kategori adı giriniz'" :class="'form-control'" :value="$category->{'name:ar'}" />
    ...
    <!---Project Kategori Ekle Modal--->
    <x-admin.modal :id="'projectCategories'" :modalTitle="'Kategori Ekle'" :headerNotBorder="''" :titleCenter="''" :footerClass="'justify-content-center'"
        :footerNotBorder="''">

        <x-slot:modalBody>
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('projectcategories.store')" :method="'POST'" :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework project_create_form'"
                :dataKt="[
                    ...
                    <x-admin.custom-grid>
                        <x-slot:gridRow>
                            ...
                            <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row'" :name="'name:ar'" :labelTag="'label'"
                                :labelText="'Arapça Kategori Adı'" :labelClass="'form-label required'" :placeholder="'Kategori adı giriniz'" :class="'form-control'" />
