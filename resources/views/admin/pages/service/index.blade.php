...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :title="'Hizmetler'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('rightContent')
    <x-admin.tags-wrapper :class="'d-flex align-items-center'">
        <x-slot:tagsWrapper>
            ...
            <x-admin.button :buttonRouteLink="'services.create'" :title="'Hizmet Ekle'" :class="'d-flex flex-center h-48px h-lg-48px'" :color="'primary'" :iconTag="'i'" :iconClass="'fs-2x me-2'" :iconType="'outline'"
                :iconName="'add-files'" />
                ...
                <x-slot:rows>
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td class="text-end">
                                <x-admin.button :link="route('services.edit', $service->id)" :class="'btn-icon '" :small="''" :light="''" :color="'primary'" :iconTag="'i'"
                                ...
                                <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline'" :action="route('services.destroy', $service->id)" :method="'POST'">
                                    <x-slot:form>
                                        @method('DELETE')
