        ...
        init: function () {
            (t = document.querySelector("#kt_sign_in_form")),
                ...
                (r = FormValidation.formValidation(t, {
                    fields: {
                        email: {
                            validators: { regexp: { regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: "Lütfen geçerli bir email adresi giriniz." }, notEmpty: { message: "Email adresi zorunludur." } },
                        },
                        password: { validators: { notEmpty: { message: "Şifre zorunludur." } } },
                    },
