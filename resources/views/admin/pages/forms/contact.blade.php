                ...
                <x-slot:cardBody>
                    <x-admin.table :id="'kt_customers_table'" :class="'align-middle table-row-dashed fs-6 gy-5'" ::theadRowClass="'text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0'" :tbodyClass="'fw-semibold text-gray-600'">
                        <x-slot:columns>
                            ...
                            <th class="fw-bolder text-gray-600">KONU</th>
                            <th class="fw-bolder text-gray-600 col-4">MESAJ</th>
                            <th class="fw-bolder text-gray-600">TELEFON</th>
                            <th class="fw-bolder text-gray-600">E-POSTA</th>
                            <th class="fw-bolder text-gray-600">TARİH</th>
                            ...
                            @if (count($contacts) > 0)
                                @foreach ($contacts as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $contact->message_subject }}
                                        </td>
                                        <td style="display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden;">
                                            {{ $contact->message }}
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <x-admin.button :class="'btn-icon me-auto'" :small="''" :light="''"
                                                ...
                                                :iconName="'eye'" :modalButton="''" :data="[
                                                    'bs-target' => '#istekoneriform-'.$contact->id,
                                                ]" />
                                                <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline'" :action="route('contactform.destroy', $contact->id)" :method="'POST'">
                                                    <x-slot:form>
                                                        @method('DELETE')
                                    ...
                                    <!---Formlar Detay Modal--->
                                    <x-admin.modal :id="'istekoneriform-'.$contact->id" :lg="''" :footerClass="'me-auto px-18'" :headerClass="'px-18'" :modalTitle="'İletişim Formu Mesaj #'.$contact->id"
                                                ...
                                                <x-slot:gridRow>
                                                    <x-admin.custom-grid :colLg="'12'">
                                                        <x-slot:gridCol>
                                                            ...
                                                            <x-admin.form-label :labelTag="'div'" :title="$contact->name_surname" :class="'text-indigo2 fs-6 fw-medium'" />
                                                        </x-slot:gridCol>
                                                    </x-admin.custom-grid>
                                                    <x-admin.custom-grid :colLg="'6'" :colClass="'mt-10'">
                                                        <x-slot:gridCol>
                                                            ...
                                                            <x-admin.form-label :labelTag="'div'" :title="$contact->e_mail" :class="'text-indigo2 fs-6 fw-medium'" />
                                                        </x-slot:gridCol>
                                                    </x-admin.custom-grid>
                                                    <x-admin.custom-grid :colLg="'6'" :colClass="'mt-10'">
                                                        <x-slot:gridCol>
                                                            <x-admin.form-label :labelTag="'div'" :title="'Telefon'" :class="'text-gray-300 fs-7 fw-medium'" />
                                                            <x-admin.form-label :labelTag="'div'" :title="$contact->phone_number" :class="'text-indigo2 fs-6 fw-medium'" />
                                                        </x-slot:gridCol>
                                                    </x-admin.custom-grid>
                                                    <x-admin.custom-grid :colLg="'12'" :colClass="'mt-10'">
                                                        <x-slot:gridCol>
                                                            ...
                                                            <x-admin.form-label :labelTag="'div'" :title="$contact->message_subject" :class="'text-indigo2 fs-6 fw-medium'" />
                                                        </x-slot:gridCol>
                                                    </x-admin.custom-grid>
                                                    <x-admin.custom-grid :colLg="'12'" :colClass="'mt-10'">
                                                        <x-slot:gridCol>
                                                            <x-admin.form-label :labelTag="'div'" :title="'Mesajı'" :class="'text-gray-300 fs-7 fw-medium'" />
                                                            <x-admin.form-label :labelTag="'div'" :title="$contact->message" />
                                                        </x-slot:gridCol>
                                                    </x-admin.custom-grid>
                                                </x-slot:gridRow>
                                            </x-admin.custom-grid>
