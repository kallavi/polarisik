...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Proje Ekle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('projects.store')" :method="'POST'" :class="'news_create_form'" :dataKt="[
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.form-input :inputParentClass="'input-group-lg mb-6'" :name="'seo_keywords:tr'"
                                                        ...
                                                        :placeholder="'Anahtar Kelime'" :id="'seo_keywords_tr'" :class="'form-control'"
                                                        :id="'news_seo_keywords'" />
