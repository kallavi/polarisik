...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Haber Güncelle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('news.update', $news->id)" :method="'POST'" :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework news_create_form'" :dataKt="[
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :placeholder="'Haber Başlık'" :class="'form-control name-tr'"
                                                                    :value="$news->{'name:tr'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :labelClass="'form-label'" :name="'slug:tr'"
                                                                    :placeholder="'Haber Url'" :class="'form-control url-tr'"
                                                                    :value="$news->{'slug:tr'}" />
                                                                ...
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'" :labelTag="'label'"
                                                                    ...
                                                                    :textareaContent="$news->{'brief:tr'}" />
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'" :labelTag="'label'"
                                                                    :labelText="'Açıklama'" :id="'description-tr'" :name="'description:tr'"
                                                                    :labelClass="'form-label'" :rows="'9'" :resizeNone="''"
                                                                    :textareaContent="$news->{'description:tr'}" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div
                                            ...
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.image-input :changeAvatar="''" :name="'image'"
                                                        ...
                                                        :textMuted="'Set the product thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted'" :imgUrl="'/' . $news->image" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20 py-4'" :cardBodyClass="'pt-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.form-select :defaultValue="'published'" :defaultValue="$news->status"
                                                        :name="'status'" :options="[
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :name="'seo_description:tr'"
                                                        ...
                                                        :placeholder="'Açıklama Girin'" :rows="'4'" :textareaContent="$news->{'seo_description:tr'}" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                        </div>
                                    </div>
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :labelClass="'form-label required'" :placeholder="'Haber Başlık'"
                                                                    :class="'form-control name-en'" :value="$news->{'name:en'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :name="'slug:en'"
                                                                    :labelClass="'form-label'" :placeholder="'Haber Url'"
                                                                    :class="'form-control url-en'" :value="$news->{'slug:en'}" />
                                                                ...
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    ...
                                                                    :resizeNone="''" :textareaContent="$news->{'brief:en'}" />
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :labelText="'Açıklama'"
                                                                    :id="'description-en'" :name="'description:en'"
                                                                    :labelClass="'form-label'" :rows="'9'"
                                                                    :resizeNone="''" :textareaContent="$news->{'description:en'}" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :labelTag="'label'"
                                                        ...
                                                        :placeholder="'Açıklama Girin'" :rows="'4'" :textareaContent="$news->{'seo_description:en'}" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                        </div>
                                    </div>
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :labelClass="'form-label required'" :placeholder="'Haber Başlık'"
                                                                    :class="'form-control text-end name-ar'" :value="$news->{'name:ar'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :name="'slug:ar'"
                                                                    :labelClass="'form-label'" :placeholder="'Haber Url'"
                                                                    :class="'form-control text-end url-ar'" :value="$news->{'slug:ar'}" />

                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :labelText="'Kısa Açıklama'"
                                                                    :id="'brief-ar'" :name="'brief:ar'"
                                                                    :labelClass="'form-label'" :rows="'9'"
                                                                    :resizeNone="''" :textareaContent="$news->{'brief:ar'}"
                                                                    :class="'text-end'" />
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :labelText="'Açıklama'"
                                                                    :id="'description-ar'" :name="'description:ar'"
                                                                    :labelClass="'form-label'" :rows="'9'"
                                                                    :resizeNone="''" :textareaContent="$news->{'description:ar'}"
                                                                    :class="'text-end'" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
