...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :title="'Portfolyolar'"  :class="'text-gray-600 fw-bold lh-1'" />
...
@section('rightContent')
    <x-admin.tags-wrapper :class="'d-flex align-items-center'">
        <x-slot:tagsWrapper>
            ...
            <x-admin.button :link="route('admin.portfolio.create')" :title="'Portfolyo Ekle'" :class="'d-flex flex-center h-48px h-lg-48px'" :color="'primary'" :iconTag="'i'"
            ...
            <x-admin.data-table :search="''" :export="''" :searchNone="''" :exportNone="''">
                ...
                <x-slot:rows>
                    @foreach ($portfolios as $portfolio)
                        <tr>
                            <td>
                                <x-admin.img-wrapper :imgPath="'/' . $portfolio->image" />
                            ...
                            <td class="text-end">
                                <x-admin.button :link="route('admin.portfolio.edit', $portfolio->id)" :class="'btn-icon '" :small="''" :light="''"
                                ...
                                <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline'" :action="route('admin.portfolio.destroy', $portfolio->id)" :method="'POST'">
                                    <x-slot:form>
                                        @method('DELETE')
