...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :title="'Projeler'" :link="route('admin.project.index')" :class="'text-gray-600 fw-bold lh-1'" />
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Proje Güncelle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('projects.update', $project->id)" :method="'POST'" :class="'project_create_form'" :dataKt="[
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :placeholder="'Proje Başlık'" :class="'form-control name-tr'"
                                                                    :value="$project->{'name:tr'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :labelClass="'form-label'" :name="'slug:tr'"
                                                                    :placeholder="'Proje Url'" :class="'form-control url-tr'"
                                                                    :value="$project->{'slug:tr'}" />
                                                                    ...
                                                                    <x-slot:customOptions>
                                                                        @foreach ($categories as $category)
                                                                            <option value="{{ $category->id }}"
                                                                                @if ($category->id == $project->category) selected @endif>
                                                                                {{ $category->{'name:tr'} }}
                                                                            </option>
                                                                        @endforeach
                                                                    </x-slot:customOptions>
                                                                ...
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'" :labelTag="'label'"
                                                                    ...
                                                                    :textareaContent="$project->{'brief:tr'}" />
                                                                <x-admin.form-textarea :id="'description-tr'" :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :labelText="'Açıklama'" :name="'description:tr'"
                                                                    :labelClass="'form-label'" :rows="'9'" :resizeNone="''"
                                                                    :textareaContent="$project->{'description:tr'}" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div
                                            ...
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.image-input :changeAvatar="''" :name="'image'"
                                                        ...
                                                        :textMuted="'Set the product thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted'" :imgUrl="'/' . $project->image" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20 py-4'" :cardBodyClass="'pt-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.form-select :defaultValue="'published'" :defaultValue="$project->status"
                                                        :name="'status'" :options="[
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :name="'seo_description:tr'"
                                                        ...
                                                        :placeholder="'Açıklama Girin'" :rows="'4'" :textareaContent="$project->{'seo_description:tr'}" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                        </div>
                                    </div>
                            ...
                            <x-admin.tab :tabsType1="'true'" :tabId="'kt_customer_view_overview_events_and_logs_tab'">
                                <x-slot:tabContent>
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :labelClass="'form-label required'" :placeholder="'Proje Başlık'"
                                                                    :class="'form-control name-en'" :value="$project->{'name:en'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :name="'slug:en'"
                                                                    :labelClass="'form-label'" :placeholder="'Proje Url'"
                                                                    :class="'form-control url-en'" :value="$project->{'slug:en'}" />
                                                                ...
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    ...
                                                                    :resizeNone="''" :textareaContent="$project->{'brief:en'}" />
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :labelText="'Açıklama'"
                                                                    :id="'description-en'" :name="'description:en'"
                                                                    :labelClass="'form-label'" :rows="'9'"
                                                                    :resizeNone="''" :textareaContent="$project->{'description:en'}" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                    ...
                                    <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20 py-4'" :cardBodyClass="'pt-0'">
                                        ...
                                        <x-slot:cardBody>
                                            <x-admin.form-select :defaultValue="'status'" :defaultValue="$project->status" :name="'status'"  :options="[
                                                'published' => 'Published',
                                                'draft' => 'Draft'
                                            ]" />
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :labelTag="'label'"
                                                        ...
                                                        :placeholder="'Açıklama Girin'" :rows="'4'" :textareaContent="$project->{'seo_description:en'}" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                        </div>
                                    </div>
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    ...
                                                                    :labelClass="'form-label required'" :placeholder="'Proje Başlık'"
                                                                    :class="'form-control text-end name-ar'" :value="$project->{'name:ar'}" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'"
                                                                    :labelText="'URL'" :name="'slug:ar'"
                                                                    :labelClass="'form-label'" :placeholder="'Proje Url'"
                                                                    :class="'form-control text-end url-ar'" :value="$project->{'slug:ar'}" />

                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :class="'text-end'"
                                                                    :labelText="'Kısa Açıklama'" :id="'brief-ar'"
                                                                    :name="'brief:ar'" :labelClass="'form-label'"
                                                                    :rows="'9'" :resizeNone="''"
                                                                    :textareaContent="$project->{'brief:ar'}" />
                                                                <x-admin.form-textarea :inputParentClass="'mb-6 fv-row col-12'"
                                                                    :labelTag="'label'" :class="'text-end'"
                                                                    :labelText="'Açıklama'" :id="'description-ar'"
                                                                    :name="'description:ar'" :labelClass="'form-label'"
                                                                    :rows="'9'" :resizeNone="''"
                                                                    :textareaContent="$project->{'description:ar'}" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
...
@section('script')
    ...
    <script>
        ...
        $('.btn-create').click(function() {
            $('.project_create_form').trigger('submit');
        });
        ...
        $('.remove-gallery').click(function() {
            ...
            slug = slug.replace("background-image: url('/", "").replace("')", "").replace('uploads/projects/', '');
            ...
            $.ajax({
                url: "{{ route('projectGallery.delete') }}",
                // datatype: "html",
