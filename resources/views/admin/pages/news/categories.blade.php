...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Haber Kategorileri'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
                        ...
                        <x-slot:rows>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <x-admin.button :class="'btn-icon '" :small="''" :light="''"
                                            ...
                                            <x-admin.form :id="'kt_ecommerce_add_product_form'" :class="'d-inline ms-3'" :action="route('newscategories.destroy', $category->id)" :method="'POST'" >
                                                <x-slot:form>
                                                    @method('DELETE')
                                ...
                                <x-admin.modal :id="'category'.$category->id" :modalTitle="'Kategori Güncelle'" :headerNotBorder="''" :titleCenter="''"
                                    ...
                                    <x-slot:modalBody>
                                        <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('newscategories.update', $category->id)" :method="'POST'"
    ...
    <x-admin.modal :id="'newsCategories'" :modalTitle="'Kategori Ekle'" :headerNotBorder="''" :titleCenter="''" :footerClass="'justify-content-center'"
        ...
        <x-slot:modalBody>
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('newscategories.store')" :method="'POST'" :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework news_create_form'"
                :dataKt="[
