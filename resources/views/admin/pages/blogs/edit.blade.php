...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('blogs.update', $blog->id)" :method="'POST'" :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework blog_create_form'" :dataKt="[
                                            ...
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.image-input :changeAvatar="''" :name="'image'"
                                                        ...
                                                        :textMuted="'Sadece *.png, *.jpg, *.jpeg ve *.svg resim dosyaları yükleyebilirsiniz.'" :imgUrl="'/' . $blog->image" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
