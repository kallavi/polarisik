...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Video Galeri Ekle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    <x-admin.wrapper-container>
        <x-slot:content>
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('admin.video.store')" :method="'POST'" :class="'blog_create_form'">
                <x-slot:form>
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                <x-admin.card :class="'card-flush border-0 bg-gray-300 bg-opacity-20 mb-6 pt-12'" :cardHeaderClass="'min-h-25px'">
                                                    ...
                                                    <x-slot:cardBody>
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :type="'hidden'" :name="'video_id'" :id="'video_id'" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Başlık'" :labelClass="'form-label required'" :name="'name:tr'"
                                                                    :placeholder="'Video Galeri Başlık'" :class="'form-control name-tr'" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Video Bağlantı'" :labelClass="'form-label'" :name="'url:tr'"
                                                                    :placeholder="'Video Bağlantı'" :class="'form-control '" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px min-w-lg-300px mb-7 ms-lg-10">
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.image-input :changeAvatar="''" :name="'image'" :size="'w-150px h-150px'" :parentClass="'my-3 text-center'" :class="'mb-3'"
                                            ...
                                            <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20 py-4'" :cardBodyClass="'pt-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    {{-- <x-admin.form-input :inputParentClass="'form-check form-switch form-check-custom form-check-solid mt-8'" :id="'featured'" :type="'checkbox'" :name="'featured'" :value="'checked'"
                                                        :checked="'checked'" :class="'form-check-input'" :labelTag="'label'" :labelRight="'true'" :labelClass="'form-check-label ms-3 text-gray-700 fs-4 fw-medium'" :labelText="'Öne Çıkar'" /> --}}
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Başlık'" :name="'name:en'"
                                                                    :labelClass="'form-label required'" :placeholder="'Video Galeri Başlık'" :class="'form-control name-en'" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Video Bağlantı'" :labelClass="'form-label'"
                                                                    :name="'url:en'" :placeholder="'Video Bağlantı'" :class="'form-control '" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px min-w-lg-300px mb-7 ms-lg-10">
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.form-input :inputParentClass="'input-group-lg mb-6'" :labelTag="'label'" :labelText="'Etiketler'" :labelClass="'form-label'" :name="'seo_keywords:en'"
                                                        :id="'seo_keywords_en'" :placeholder="'Anahtar Kelime'" :class="'form-control'" />
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Başlık'" :name="'name:ar'"
                                                                    :labelClass="'form-label required'" :placeholder="'Video Galeri Başlık'" :class="'form-control text-end name-ar'" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'Video Bağlantı'" :labelClass="'form-label'"
                                                                    :name="'url:ar'" :placeholder="'Video Bağlantı'" :class="'form-control '" />
                                                            </x-slot:gridRow>
                                                        </x-admin.custom-grid>
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px min-w-lg-300px mb-7 ms-lg-10">
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    <x-admin.form-input :inputParentClass="'input-group-lg mb-6'" :labelTag="'label'" :labelText="'Etiketler'" :labelClass="'form-label'" :name="'seo_keywords:ar'"
                                                        :id="'seo_keywords_ar'" :placeholder="'Anahtar Kelime'" :class="'form-control text-end'" />
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :labelTag="'label'" :labelText="'Sayfa Açıklaması'" :class="'text-end'" :labelClass="'form-label'"
