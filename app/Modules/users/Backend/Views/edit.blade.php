...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Kullanıcı Güncelle'" :class="'text-gray-600 fw-bold lh-1'" />
                        ...
                        <x-slot:tabContent>
                            <div class="d-flex flex-column flex-xl-row">
                                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 ">
                                    <x-admin.form :action="route('admin.users.update', $user->id)" :method="'POST'" id="'kt_ecommerce_add_product_form'" :class="'project_create_form form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework'" :dataKt="[
                                                        ...
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'İsim'" :name="'name'" :labelClass="'form-label required'"
                                                                    :placeholder="'İsim'" :class="'form-control'" :value="$user->name" :required="''" />
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row col-6'" :labelTag="'label'" :labelText="'E-Mail'" :labelClass="'form-label'" :name="'email'"
                                                                    :placeholder="'E-mail'" :class="'form-control'" :value="$user->email" :required="''"  />
