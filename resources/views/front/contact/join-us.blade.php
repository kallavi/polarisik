...
@endsection
@section('fullContain')
    <div class="bizeKatilinBg d-none d-lg-block"><img src="{{ asset('assets/statics/bize-katilin-bg.png') }}" alt="">
    </div>
    <div class="bizeKatilinBgSmall d-none d-lg-block"><img src="{{ asset('assets/statics/logo-dark-thumb.png') }}"
            alt=""></div>
    <div class="row pb-lg-2 pt-1 pt-lg-0 mx-auto">
        <div class="col-xxxl-5 col-xxl-6 col-xl-7 col-lg-8 mx-auto px-4 pb-lg-0 pb-2 pt-1 pt-lg-0">
            <form method="POST" action="{{ route('joinus.store') }}" id="bizeKatilimForm"
                class="row type2 g-lg-4 g-0 needs-validation px-lg-4 px-3 mt-lg-0 pb-4 pbb-lg-0 mt-3" novalidate>
                @csrf
                <div class="form-floating col-12 mb-2 mb-lg-0">
                    <input type="text" class="form-control textMask" id="name" name="name_surname"
                ...
                <div class="form-floating col-lg-6 custom-birthday mb-2 mb-lg-0">
                    <input type="text" name="birthday" class="form-control birthdayMask datepicker" id="birthday"
                        placeholder="Doğum Tarihi (GG/AA/YY)" required>
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="phone_number" class="form-control phoneMask" id="phone"
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="email" name="e_mail" class="form-control emailMask" id="eposta"
                        placeholder="E-Postanız" required>
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="height" class="form-control allNumber" id="messageSubject"
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="weight" class="form-control allNumber" id="messageSubject"
                        placeholder="Mesaj Konusu" required>
                ...
                <div class="position-relative col-12 mb-2 mb-lg-0">
                    <div class="custom-file d-flex align-items-center">
                        <input type="file" name="image" id="fileInput" accept=".jpg, .jpeg, .png"
                            class="custom-file-input" aria-label="Fotoğraf Yükleyiniz" required style="display: none;"
                            onchange="displayFileName()">
                        <img id="imagePreview" style="max-width: 100px; max-height: 100px; display: none;" />
                        <label class="custom-file-label" for="fileInput" id="customFileLabel">Fotoğrafınızı
                            Yükleyiniz</label>
                        <button type="button" id="addButton" class="ms-auto btn"
                            onclick="document.getElementById('fileInput').click()"><span class="icon-plus"></span></button>
                        <button type="button" id="deleteButton" class="ms-auto btn" onclick="deleteImage()"
                            style="display: none;"><span class="icon-plus"></span></button>
                        <div class="invalid-tooltip">Lütfen Fotoğrafınızı .jpg veya .png Formatında Yükleyiniz.</div>
                    </div>
                </div>
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="language" class="form-control textMask" id="messageSubject"
                        placeholder="Mesaj Konusu" required>
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="missing_piece" class="form-control textMask" id="messageSubject"
                        placeholder="Mesaj Konusu" required>
                ...
                <div class="form-floating col-lg-6 mb-2 mb-lg-0">
                    <input type="text" name="identity_number" class="form-control tcNo" id="messageSubject"
                        placeholder="Mesaj Konusu" required>
                ...
                <div class="form-floating col-12 mb-2 mb-lg-0">
                    <input type="text" name="account_name" class="form-control textMask" id="ibanName"
                        placeholder="Hesap Adı Giriniz" required>
                ...
                <div class="form-floating col-12 mb-2 mb-lg-0">
                    <input type="text" name="iban" class="form-control ibanMask" id="ibanNo"
                        placeholder="IBAN Giriniz" required>
                ...
                <div class="col-lg-4 col-12 ms-lg-auto pe-lg-4 pt-1 mb-2 mb-lg-0 mt-lg-5">
                    <button class="btn btn-primary rounded-pill text-white ms-lg-auto me-lg-3 mx-auto" type="submit">
                        Gönder</button>
                </div>
            </form>
        </div>
