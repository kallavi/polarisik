            ...
            :tbodyClass="'fw-semibold text-gray-600'">
                ...
                <x-slot:rows>
                    <tr>
                        ...
                        <td>
                            <a href="{{route('home')}}" class="text-gray-900 fw-medium mb-1">AHDE VEFA RESİM SERGİSİ AÇILDI</a>
                        </td>
                        <td>
                            Konseptler
                        </td>
                    ...
                    <tr>
                        <td><x-admin.img-wrapper :imgPath="'assets/images/haber2.png'"/></td>
                        <td>
                            <a href="{{route('home')}}" class="text-gray-900 fw-medium mb-1">BEDEN EĞİTİMİ ÖĞRETMENLERİ İSTİŞARE TOPLANTISI</a>
                        </td>
                        <td>
                           Servisler
                        </td>
                    ...
                    <tr>
                        <td><x-admin.img-wrapper :imgPath="'assets/images/haber1.png'"/></td>
                        <td>
