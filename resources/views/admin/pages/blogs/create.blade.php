...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('blogs.store')" :method="'POST'" :class="'form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework blog_create_form'" :dataKt="[
