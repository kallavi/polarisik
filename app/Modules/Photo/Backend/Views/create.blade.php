...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Fotoğraf Galeri Ekle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    <x-admin.wrapper-container>
       ...
       {{--  'kt_customer_view_overview_events_and_logs_tab2' => 'Arapça',  --}}
            ...
            <x-admin.form :id="'kt_ecommerce_add_product_form'" :action="route('admin.photo.store')" :method="'POST'" :class="'blog_create_form'">
                <x-slot:form>
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                <x-admin.card :class="'card-flush border-0 bg-gray-300 bg-opacity-20 mb-6 pt-12'" :cardHeaderClass="'min-h-25px'">
                                                    ...
                                                    <x-slot:cardBody>
                                                        <x-admin.custom-grid>
                                                            <x-slot:gridRow>
                                                                <x-admin.form-input :type="'hidden'" :name="'photo_id'" :id="'photo_id'" />
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if (JSON.parse(result).status == "success") {
                                    ...
                                    location.href = $("#photo_id").val()+"/edit";
                                } else {
                                    console.log("error");
                                }
                            }
